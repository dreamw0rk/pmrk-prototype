...
export const HEROES: Counterparty[] = [
  {
    ...
    news: [
      { id: 'n-gpn1', date: '2026-06-16', title: '«Эксперт РА» подтвердил рейтинг на уровне ruAAA', source: 'Яндекс.Новости', sentiment: 'positive', summary: 'Максимальный уровень по национальной шкале, прогноз «стабильный».' },
      { id: 'n-gpn2', date: '2026-05-22', title: 'Совет директоров рекомендовал финальные дивиденды за 2025 год', source: 'Яндекс.Новости', sentiment: 'positive', summary: 'Финальные 28,11 ₽ на акцию, с учётом промежуточных 17,30 ₽ — 45,41 ₽ за год (215,3 млрд ₽). ГОСА 25.06.2026, закрытие реестра 06.07.2026.' },
      { id: 'n-gpn3', date: '2026-04-13', title: 'Результаты за 2025 год по МСФО: выручка 3,61 трлн ₽ (−12%)', source: 'Яндекс.Новости', sentiment: 'negative', summary: 'EBITDA −21%, чистая прибыль акционеров 245,8 млрд ₽ против 479,5 млрд ₽ годом ранее — давление санкционного дисконта и крепкого рубля.' },
      { id: 'n-gpn4', date: '2026-04-02', title: 'АКРА подтвердило кредитный рейтинг на уровне AAA(RU)', source: 'Яндекс.Новости', sentiment: 'positive', summary: 'Прогноз «стабильный»; очень сильный бизнес-профиль — низкая себестоимость добычи, высокие объём и глубина переработки.' },
      { id: 'n-gpn5', date: '2025-10-23', title: 'ЕС ввёл полный запрет на сделки в 19-м пакете санкций', source: 'Яндекс.Новости', sentiment: 'negative', summary: 'Компания включена в Annex XIX Регламента 833/2014 (ст. 5aa); отменены изъятия для нефтегазовых операций и ряда зарубежных проектов.' },
      { id: 'n-gpn6', date: '2025-01-10', title: 'OFAC включил «Газпром нефть» в SDN-список, Великобритания заморозила активы', source: 'Яндекс.Новости', sentiment: 'negative', summary: 'Минфин США внёс компанию и ряд дочерних обществ в блокирующий список (Executive Order 14024); в тот же день OFSI ввела заморозку активов.' },
    ],
    courtCases: [
  ...
  },
  {
    ...
    news: [
      { id: 'n-b1', date: '2026-06-08', title: 'Поставщик подал иск о взыскании 34 млн ₽ задолженности', source: 'pravo.ru', sentiment: 'negative', summary: 'Арбитраж принял к производству иск ООО «ТЭК-Снаб» к Балтийской ТК на 34,2 млн ₽ — просрочка по договору поставки.' },
      { id: 'n-b2', date: '2026-05-30', title: 'Снижение объёмов закупки в Северо-Западном регионе', source: 'Яндекс.Новости', sentiment: 'negative', summary: 'По данным отраслевого обзора, у компании сократились отгрузки на 18% кв/кв.' },
      { id: 'n-b3', date: '2026-04-02', title: 'Назначен новый финансовый директор', source: 'Яндекс.Новости', sentiment: 'neutral', summary: 'Финансовый блок возглавил Кузнецов А.И. (ранее — «Трансойл»).' },
    ],
    courtCases: [
  ...
  },
  {
    ...
    news: [
      { id: 'n-s1', date: '2026-05-28', title: 'Расширение логистического хаба в Усть-Луге', source: 'Яндекс.Новости', sentiment: 'positive', summary: 'Запущена вторая очередь перевалочного комплекса, рост мощности на 25%.' },
    ],
    courtCases: [],
    sanctions: [],
    pdForecast: [
  ...
  },
  {
    ...
    news: [
      { id: 'n-n1', date: '2026-06-01', title: 'Введена процедура наблюдения', source: 'bankrot.fedresurs.ru', sentiment: 'negative', summary: 'Арбитражный суд ввёл наблюдение по заявлению кредитора, требования 88 млн ₽.' },
    ],
    courtCases: [
  ...
  },
  {
    ...
    news: [
      { id: 'n-y1', date: '2026-06-03', title: 'Рост просроченной задолженности перед поставщиками', source: 'Яндекс.Новости', sentiment: 'negative', summary: 'Отмечен рост ПДЗ; компания ведёт переговоры о реструктуризации.' },
    ],
    courtCases: [
